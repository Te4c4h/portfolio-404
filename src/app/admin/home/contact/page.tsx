...
function SortableRow({
  ...
  return (
    <div ref={setNodeRef} style={style} className="flex items-center gap-3 bg-[#181818] border border-[#2a2a2a] rounded-lg px-4 py-3">
      <button {...attributes} {...listeners} className="cursor-grab text-[#555] hover:text-[#888]"><FiMenu size={16} /></button>
  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-[#fafafa]">Home Page — Contact Links</h1>
        <button onClick={openAdd} className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium bg-[#70E844] text-[#131313] hover:bg-[#5ed636]"><FiPlus size={16} /> Add</button>
      </div>
